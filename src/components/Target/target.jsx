  ...
  useEffect(() => {
    axios
      ...
      .then((responseProject) => {
        ...
        const switchButtonDetails = responseProject.data.data[0].twoD_threeD_data;
...
const handleOpenTrackerOption=()=>{
                ...
                <Row className="justify-content-between tab-list flex-nowrap target-left-sidebar">
                  ...
                  >
                    ...
                    <div className="mt-3">
                      ...
                      <button className="btn rounded-2" id="browse-btn" onClick={handleshowbrowsemedia}><i className="bi bi-upload"></i>Browse media library</button>
                      </div>
                                              ...
                                              >
                                                <div className="nav-items">
                                                  ...
                                                  >
                                                    ...
                                                    <a className={`orientations ${cont_orientation === 'Upright' ? 'active' : ''}`} onClick={((e)=> handleSelectOrientation(e , 'Upright'))}>
                                                    Upright
                                                    </a>
                                                  </div>
                                                  <div className="nav-links">
                                                  ...
                                                  >
                                                    ...
                                                    <a className={`orientations ${cont_orientation === 'Flat' ? 'active' : ''}`} onClick={((e)=> handleSelectOrientation(e , 'Flat'))}>
                                                    Flat
                                                    </a>
                                                  </div>
                                                </div>
                                    ...
                                    >
                                      ...
                                      <Accordion.Body id="track-top">
                                        <div className="row track-with">
                                          ...
                                          <button
                                            data-testid="ShelfDrawerBtn"
                                            class="btn-action-save btn-upload DrawerBtn--bdcva Open--EFZA8 "
                                          >
 ...
 <Modal
      ...
      {/* End---model data */}
                ...
                <Modal id="browse-media-popup" show={showbrowsemedia} onHide={handleDeleteClose}>
                <Modal.Header closeButton>
  ...
  <div className="field mb24 drop-media-outer">
    <div className="input-wrapper" id="drop-media-files">
      ...
      <input type="file" id="img-upload-popup" onChange={handleImageInput} />
    </div>
  </div>
  ...
  <div className="dropdown custom-drop-down browse-sort-drop-down">
    ...
    >
      <path d="M15.5 27a.5.5 0 01.09.992L15.5 28h-4a.5.5 0 01-.09-.992L11.5 27h4zm10-8a.5.5 0 01.492.41l.008.09v6.793l2.146-2.147.07-.057a.5.5 0 01.695.695l-.057.07-3 3a.498.498 0 01-.227.13l-.084.014h-.086a.498.498 0 01-.241-.087l-.07-.057-3-3a.5.5 0 01.638-.765l.07.057L25 26.293V19.5a.5.5 0 01.5-.5zm-5 0a.5.5 0 01.09.992L20.5 20h-9a.5.5 0 01-.09-.992L11.5 19h9zm8-8a.5.5 0 01.09.992L28.5 12h-17a.5.5 0 01-.09-.992L11.5 11h17z"></path>
        ...
        <p class="sort-head">Sort</p><FontAwesomeIcon icon={faChevronDown} />
      </a>
      <ul className="dropdown-menu text-small shadow">
        <li><a className="dropdown-item"> By date uploaded
       </a></li>
  ...
  <Tabs defaultActiveKey="tab1" id="browse-media-tabs" className="mt-3">
    <Tab eventKey="tab1" title="All">
      <p>
       ...
       <div class="browse-inner-images-height">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/IUN664s7N-c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
       </div>
       <div class="browse-inner-images-height">
  ...
  <svg
    ...
    <div class="select-file-btn-outer">
      ...
      <Tab.Container id="file-selects-drop-down" defaultActiveKey="first">
                      ...
                      >
                        <Accordion>
                                <Accordion.Item eventKey="0">
                                  ...
                                  <Accordion.Body>
                                  <div class="flex acenter preview-row"><p>Category</p>
                                  <p class="f1 jc-end">Image</p></div>
                                  <div class="flex acenter preview-row">
                                  <p>Type</p><p class="f1 jc-end">Image</p></div>
                                  <div class="flex acenter preview-row">
                                  <p>Date uploaded</p><p class="f1 jc-end">Jun 19, 2023</p></div>
                                  <div class="flex acenter preview-row"><p>Uploaded by</p>
                                  <p class="f1 jc-end ellipsis">Web Developer</p></div>
                                  <hr/>
                                  ...
                                  <span class="delete-file-txt">Delete file</span>
                                  </div>
                                                  </Accordion.Body>
                                </Accordion.Item>
								 </Accordion>
