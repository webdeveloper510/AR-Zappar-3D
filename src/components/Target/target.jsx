...
const Target = () => {
  ...
  //  state data from get image api

  const [ImgMirror, setImgMirror] = useState();
  const [ImgRotation_x, setImgRotation_x] = useState();
  const [ImgRotation_y, setImgRotation_y] = useState();
  const [ImgRotation_z, setImgRotation_z] = useState();
  const [Imgdepth, setImgdepth] = useState();
  const [Imgheight, setImgheight] = useState();
  const [Imgposition_d, setImgposition_d] = useState();
  const [Imgposition_x, setImgposition_x] = useState();
  ...
  const apiOn2Dbutton = () => {
    axios
      ...
      .then(function (response) {
        console.log(
          response,
          "RESPONSE 2D 2D 2D 2D 2D 2D 2D 2D 2D 2D 2D action <<<<============"
        );
      })
      .catch(function (err) {
        console.log(err);
