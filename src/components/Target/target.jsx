...
const Target = () => {
  ...
  // States for the Two-D and Three-D Switch ---------------------------------------------->Opacity
  ...
  const getImgName = (imgUrl) => {const splittedArray = imgUrl.split("/");
    return splittedArray[splittedArray.length - 1];
  };

  useEffect(() => {
    const delay = 500;
    const timeoutId = setTimeout(() => {setDebouncedSearchTerm(searchTerm)}, delay);

    return () => {clearTimeout(timeoutId)}}, [searchTerm]);
  ...
  const getUserProjectDetail = async () => {
    ctx.setloader(true)
    try {
      const response = await axios.get(API.BASE_URL +"user_projects_details/" +localStorage.getItem("id") +"/");
    ...
    finally{setTimeout(()=>ctx.setloader(false),0)
    }
  };
  useEffect(() => {
  ...
  const handleSubmit = (sceneName) => {
    ...
    if (SceneType === null) {setShow(true);
    ...
    axios.get(API.BASE_URL + "scene_details/" + id+'/')
      ...
      .then(function (responseProject) {
        ...
        const switchButtonDetails =
          responseProject.data.data[0].Twod_3D;
  ...
  useEffect(() => {
    ctx.setloader(true)
    axios.get(API.BASE_URL + "scene_details/" + s_scene_id + "/")
      .then((responseProject) => {
        ...
        const switchButtonDetails = responseProject.data.data[0].Twod_3D;
        const checkStatus = document.getElementById("checkID");
          lettwoDthreeDID(switchButtonDetails.threed_id);
          if (switchButtonDetails.value) {
            checkStatus.checked = true;
          } else {
            checkStatus.checked = false;
          }
  ...
  const handleImageInput = (e) => {
    ...
    reader.onload = (event) => {
      ...
      image.onload = () => {
        ...
        ctx.setloader(true)
        axios.post(API.BASE_URL + "upload-image/", formData)
          .then(function (response) {
  ...
  const imageDimensions = (id, threeewidth, threeeheight) => {
    ...
    axios.post(API.BASE_URL + "/image_transform/", formData)
      .then(function (response) {})
      .catch(function (error) {});
  };
  ...
  const imageDimentionUpdate = () => {
    ...
    // ctx.setloader(true)
    axios.put(API.BASE_URL +"/image_transform/" +contentImgVdo[0].image_transform.id +"/",payload)
  ...
  const videoDimentionUpdate = () => {
    ...
    // ctx.setloader(true)
    axios.put(API.BASE_URL +"/video_transform/" +contentImgVdo[0].video_transform.id +"/",payload)
      .then((res) =>  ctx.setloadContent((prev)=>!prev))
  ...
  const textDimentionUpdate = () => {
    ...
    // ctx.setloader(true)
    axios.put(API.BASE_URL +"/text_transform/" +contentImgVdo[0].text_transform.id +"/",payload)
      .then((res) =>  ctx.setloadContent((prev)=>!prev))
  ...
  const handleInputChange = (event) => {
    ...
    videoElement.onloadedmetadata = () => {
      ...
      axios.post(API.BASE_URL + "upload-video/", FormData, {
          ...
          onUploadProgress: (progressEvent) => {const uploadPercentage = Math.round((progressEvent.loaded / progressEvent.total) * 100);setProgress(uploadPercentage);},
        }).then(function (response) {
  ...
  const setVideoData = (id, width, height) => {
    ...
    formData.append("Mirror", null);
    ctx.setloader(true)
    axios.post(API.BASE_URL + "video_transform/", formData, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      }).then(function (response) {
  ...
  const videoTransitionAPI = (id) => {
    ...
    ctx.setloader(true)
    axios.post(API.BASE_URL + "video_transition/" + id + "/", formData, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      }).then(function (response) {})
  ...
  const thecheckfunction = (e) => {
    ...
    // ctx.setloader(true)
    axios.put(API.BASE_URL + "twod_threed/" + twoDthreeDID + "/", formdata, {})
      .then(function (res) {})
      .catch(function (err) {})
      .finally(()=>{
       });
  ...
  const getBtnDataById = () => {
    ctx.setloader(true)
    axios.post(API.BASE_URL + "GetButtondata/" + s_scene_id)
      .then(function (response) {})
      .catch(function (err) {})
      .finally(()=>{
        setTimeout(()=>{ ctx.setloader(false)},0)
  ...
  const deleteBtnDataById = () => {
    ctx.setloader(true)
    axios.delete(API.BASE_URL + "GetButtondata/" + s_scene_id)
      .then(function (response) {})
      .catch(function (err) {})
      .finally(()=>{
        setTimeout(()=>{ ctx.setloader(false)},0)
  ...
  const getTextDataById = () => {
    ctx.setloader(true)
    axios.post(API.BASE_URL + "get-all-text-data/" + s_scene_id)
      .then(function (response) {})
      .catch(function (err) {})
      .finally(()=>{
        setTimeout(()=>{ ctx.setloader(false)},0)
  ...
  const deleteTextDataById = (id) => {
    ctx.setloader(true)
    axios.delete(API.BASE_URL + "get-all-text-data/" + id)
      .then(function (response) {
  ...
  const getImageDataById = () => {
    ctx.setloader(true)
    axios.get(API.BASE_URL + "get-image-data/" + s_scene_id)
      .then(function (response) {})
      .catch(function (err) {})
      .finally(()=>{
        setTimeout(()=>{ ctx.setloader(false)},0)
  ...
  const deleteImageDataById = (id) => {
    ctx.setloader(true)
    axios.delete(API.BASE_URL + "get-image-data/" +id+'/')
      .then(function (response) {
  ...
  const deleteVideoDataById = (id) => {
    ctx.setloader(true)
    axios.delete(API.BASE_URL + "get-video-data/" + id +'/')
      .then(function (response) {
        toast.success('successfully deleted');
        setselectedVideo(null);
        setselectedFile(null);
  ...
  const getVideoDataById = () => {
    ctx.setloader(true)
    axios.get(API.BASE_URL + "get-video-data/" + s_scene_id)
      .then(function (response) {})
      .catch(function (err) {})
      .finally(()=>{
        setTimeout(()=>{ ctx.setloader(false)},0)
  ...
  const getThreeDModelDataById = () => {
    ctx.setloader(true)
    axios.get(API.BASE_URL + "get-threed-model-Data/" + s_scene_id)
      .then(function (response) {})
      .catch(function (err) {})
      .finally(()=>{
        setTimeout(()=>{ ctx.setloader(false)},0)
  ...
  const deleteThreeDModelDataById = (id) => {
    ctx.setloader(true)
    axios.delete(API.BASE_URL + "get-threed-model-Data/" + id)
      .then(function (response) {})
      .catch(function (err) {})
      .finally(()=>{
        setTimeout(()=>{ ctx.setloader(false)},0)
  ...
  const getSceneDataById = () => {
    ctx.setloader(true)
    axios.get(API.BASE_URL + "get-scene-data/" + s_scene_id)
      .then(function (response) {})
      .catch(function (err) {})
      .finally(()=>{
        setTimeout(()=>{ ctx.setloader(false)},0)
  ...
  const deleteSceneDataById = () => {
    ctx.setloader(true)
    axios.delete(API.BASE_URL + "get-scene-data/" + s_scene_id)
      .then(function (response) {})
      .catch(function (err) {})
      .finally(()=>{
        setTimeout(()=>{ ctx.setloader(false)},0)
  ...
  const getProjectContentDataById = (id) => {
    ctx.setloader(true)
    axios.get(API.BASE_URL + "getproject-contentdata/" + id)
      .then(function (response) {})
      .catch(function (err) {})
      .finally(()=>{
        setTimeout(()=>{ ctx.setloader(false)},0)
  ...
  const deleteProjectContentDataById = (id) => {
    ctx.setloader(true)
    axios.delete(API.BASE_URL + "getproject-contentdata/" + s_scene_id)
      .then(function (response) {})
      .catch(function (err) {})
      .finally(()=>{
        setTimeout(()=>{ ctx.setloader(false)},0)
    ...
    reader.onload = (event) => {
      ...
      axios.put(API.BASE_URL+'project_content/'+projectContentID+'/',{'target_image':imageFile , "dimensions_w" :TargetFileWidth ,"dimensions_h" :TargetFileHeight , "opacity":100},{
        ...
        formData.append("image", imageFile)
          axios.post(API.BASE_URL2+"upload",formData,{
          }).then(function(response) {
...
const trainedImageUrl=(url)=>{
  ...
  const handleSelectOrientation = (e, type) => {
    ...
    ctx.setloader(true)
    axios.put(API.BASE_URL + "project_content/" + id + "/", formdata, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      })
