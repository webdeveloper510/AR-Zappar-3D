...
const twoDThreeD=(id)=>{
  ...
  useEffect(() => {
    WebFont.load({
      google: {
        families: ['Henny Penny, cursive', 'Droid Sans', 'Chilanka', 'Orbitron', 'Sacramento', 'Roboto',
        'Cookie', 'Comfortaa', 'Philosopher', 'Quicksand', 'Trocchi', 'Advent Pro', 'Henny Penny', 'Snowburst One',
        'Wallpoet'
      ]
      }
    });
    ...
    axios
      ...
      .then(function (response) {
        console.log(
          ...
          "RESPONSE from VIDEO ACTION YES <<<<============"
        );
      })
      .catch(function (err) {
        console.log(err);
  ...
  const videoTransitionAPI = (id) => {
    ...
    axios
      ...
      .then(function (response) {
        console.log(
          response.data,
          "RESPONSE video Transition YES YES YES<<<<============"
        );
      })
      .catch(function (err) {
        console.log(err);
  ...
  const getBtnDataById = (id) => {
    axios
      .post(API.BASE_URL + "GetButtondata/" + id)
      .then(function (response) {
  ...
  const deleteBtnDataById = (id) => {
    axios
      .delete(API.BASE_URL + "GetButtondata/" + id)
      .then(function (response) {
  ...
  const getTextDataById = (id) => {
    axios
      .post(API.BASE_URL + "get-all-text-data/" + id)
      .then(function (response) {
  ...
  const getImageDataById = (id) => {
    axios
      .get(API.BASE_URL + "get-image-data/" + id)
      .then(function (response) {
  ...
  const getVideoDataById = (id) => {
    axios
      .get(API.BASE_URL + "get-video-data/" + id)
      .then(function (response) {
  ...
  const getThreeDModelDataById = (id) => {
    axios
      .get(API.BASE_URL + "get-threed-model-Data/" + id)
      .then(function (response) {
  ...
  const getSceneDataById = (id) => {
    axios
      .get(API.BASE_URL + "get-scene-data/" + id)
      .then(function (response) {
  ...
  const deleteSceneDataById = (id) => {
    axios
      .delete(API.BASE_URL + "get-scene-data/" + id)
      .then(function (response) {
  ...
  const deleteProjectContentDataById = (id) => {
    axios
      .delete(API.BASE_URL + "getproject-contentdata/" + id)
      .then(function (response) {
        console.log(
          response,
  ...
  const deleteDataBySceneId = (id) => {
    axios
      .delete(API.BASE_URL + "scene_details/" + id)
      .then(function (response) {
          ...
          <div className="row col-md-12 justify-content-between">
              ...
              <Tab.Container id="left-tabs-example">
                <Row className="justify-content-between tab-list flex-nowrap target-left-sidebar">
                  <Col lg={3} className="side-tab mb-5 mb-md-0">
                    <Nav
                      // variant="pills"
                      className={`flex-column side-main ${isOpen ? 'target-pills' : ''}`}
                    >
                      <Nav.Item>
                  ...
                  <Tab.Pane
                    eventKey={isOpen ? 'second' : null} onClick={()=>setisOpen(!isOpen)}
                    className="bg-light p-4 tab-content"
                  >
                    ...
                    <p className="m-0 third-head">Add a paragraph </p><br/>
                    ...
                    <div className="buttons text-side-btn">
                      ...
                      <p className="round Handwritten-title">Handwritten title</p>
                  ...
                  <Tab.Pane
                    eventKey={isOpen ? "third" : null} onClick={()=>setisOpen(!isOpen)}
                    className="bg-light p-4 tab-content"
                  >
                  ...
                  <Tab.Pane
                    eventKey={isOpen ? "fourth" : null} onClick={()=>setisOpen(!isOpen)}
                    className="bg-light p-4 tab-content"
                  >
                    <p className="m-0 fs-4 fw-semibold">
                      Videos
                  ...
                  <Tab.Pane
                    eventKey={isOpen ? "fifth" : null} onClick={()=>setisOpen(!isOpen)}
                    className="bg-light p-4 tab-content"
                  >
                    <p className="m-0 fs-4 fw-semibold">
                      3D
            ...
            <div className="col-md-9 p-0 m-0 target-center" id="tracker" onClick={()=>setisOpen(false)}>
              <canvas
                ...
                style={{ zIndex: isOpen ? 1 : -1, backgroundColor:'transparent' }}
                // ref={canvasRef}
              >
              </canvas>
              <ModelAr />
                                          ...
                                          <Accordion>
                                            <Accordion.Item eventKey="0">
                                              ...
                                              <svg
                                                      ...
                                                      viewBox="0 0 22 22"
                                                    >
                                                      <g fill="none" transform="translate(-11012.146 -515.646)">
                                                        <path d="M0 0H20V20H0z" transform="translate(11012.5 516)"></path>
                                                        <g
                                                          stroke="#4A90E2"
                                                          strokeWidth="1"
                                                ...
                                                >
                                                  ...
                                                  >
                                                    ...
                                                    <svg
                                                      ...
                                                      >
                                                        <g data-name="Group 2">
                                                          <path fill="none" d="M0 0H20V20H0z" data-name="Rectangle 68"></path>
                                                          <path
                                                            fill="#344B60"
                                              ...
                                              <g fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
                                                ...
                                                ></path>
                                                  ...
                                                  >
                                                    ...
                                                    >
                                                      <g fill="none">
                                                        <path d="M0 0H20V20H0z" data-name="Rectangle 66"></path>
                                                        <g stroke="#344B60" strokeMiterlimit="10" strokeWidth="1">
                                                          <path
                                                            stroke="none"
                                                        ...
                                                        <g strokeMiterlimit="10" data-name="Rectangle Copy 16">
                                                          <path
                                                  ...
                                                  >
                                                    <div className="Container--Mc1y-">
                                                      ...
                                                      viewBox="0 0 20 20"
                                                    >
                                                      <g data-name="Atom/Icon/Social" transform="translate(-3)">
                                                        <path
                                                          fill="#344B60"
                                                    ...
                                                    </svg>Links to social network</span>
                                                    </div>
                                                  </div>
