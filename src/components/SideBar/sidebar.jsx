...
const SideBar = () => {
  ...
  return (
    <div className="col-md-1 p-0 m-0 project-side main-page-left-bar">
      <div className="container-outer">
        <div className="d-flex flex-column flex-shrink-0 p-3 project-main">
          <ul className="nav nav-pills flex-column mb-auto" id="side-navbar-listing">
            <li title="Projects"
              className="nav-item"
